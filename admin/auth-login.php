            ...
            <div class="card-body">
              ...
              if (isset($_POST["login"])) { //jika tombol login di klik
                ...
                if ($username != "" && $password != "") {
                  ...
                  $em = mysqli_query($con, "select tb_pengguna.*, tb_user.username, tb_user.password
                                			from tb_pengguna inner join tb_user on tb_pengguna.id_pengguna = tb_user.id_pengguna
                                			where username = '$username' and password = '$password' LIMIT 1");
                  $data = mysqli_fetch_array($em);

                  if (empty($data)) // username atau password salah
                  {
                    echo "<div class='alert alert-danger alert-icon alert-dismissible fade show'>
							<strong>Error!</strong> 
